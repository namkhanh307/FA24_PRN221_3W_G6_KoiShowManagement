...
namespace KoiShowManagement.Repositories
{
    ...
    {
        protected FA24_PRN221_3W_G6_KoiShowManagementContext _context;

        public GenericRepository()
        {
            _context ??= new FA24_PRN221_3W_G6_KoiShowManagementContext();
        }

        public GenericRepository(FA24_PRN221_3W_G6_KoiShowManagementContext context)
        {
            _context = context;
        }
